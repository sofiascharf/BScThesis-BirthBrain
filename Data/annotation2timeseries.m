...
%% --- USER SETTINGS ---
baseStart   = datetime(2025,10,10,02,02,05);  % File 1 starts here
sessionDurS = 3600;                           % Each file is 1 hour
dt          = seconds(1);                     % Output sampling
outCSV      = 'timeseries_m2_{stillbirth}_annotations.csv';

files = { ...
 'Raw data-StillbirthManualScoring-Trial    11 (1).xlsx'
 'Raw data-StillbirthManualScoring-Trial    12 (1).xlsx'};
